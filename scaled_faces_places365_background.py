...
facemask = 'FaceMask'
CroppedFolder1 = "places365mask32"
CroppedFolder2 = "places365mask64"
CroppedFolder3 = "places365mask128"
CroppedFolder4 = "places365mask200"
background = 'test1'
	...
	for filename in os.listdir(os.path.join(binarymask,directory)):
		...
		try:
			for k in range(4):
				...
				backg = plt.imread(background+'/'+str(i)+'.jpg')

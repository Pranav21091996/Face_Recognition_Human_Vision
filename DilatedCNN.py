...
Dataset1_Input = np.load(sys.argv[1]+'_Normal_Input.npy')
Dataset1_Label = np.load(sys.argv[1]+'_Normal_Labels.npy')
Dataset2_Input = np.load(sys.argv[2]+'_Normal_Input.npy')
Dataset2_Label = np.load(sys.argv[2]+'_Normal_Labels.npy')
Dataset3_Input = np.load(sys.argv[3]+'_Normal_Input.npy')
Dataset3_Label = np.load(sys.argv[3]+'_Normal_Labels.npy')
Dataset4_Input = np.load(sys.argv[4]+'_Normal_Input.npy')
Dataset4_Label = np.load(sys.argv[4]+'_Normal_Labels.npy')
Dataset5_Input = np.load(sys.argv[5]+'_Normal_Input.npy')
Dataset5_Label = np.load(sys.argv[5]+'_Normal_Labels.npy')
...
img_size = 64
i=0
num_classes = max(Dataset1_Label)+1
...
one_hot_labels_test1 = one_hot_encode(test_label1,num_classes)
one_hot_labels_test2 = one_hot_encode(test_label2,num_classes)
one_hot_labels_test3 = one_hot_encode(test_label3,num_classes)
one_hot_labels_test4 = one_hot_encode(test_label4,num_classes)
one_hot_labels_test5 = one_hot_encode(test_label5,num_classes)
...
logits,l2_loss = dilated_conv_net(x, keep_prob)
Y_pred = tf.nn.softmax(logits)
cost = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits = logits, labels = y)) + l2_loss*beta
...
suffixes = {0:sys.argv[1],1:sys.argv[2],2:sys.argv[3],3:sys.argv[4],4:sys.argv[5]}
k=0
